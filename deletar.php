...
<a href="home.php">
    ...
    <h2>Arquivar Livros</h2>

    <form action="arquivar_livro.php" method="post" class="formulario">
    <div class="form-group">
        ...
        <div class="form-group">
            <label for="sinopse">Motivo do Arquivamento:</label>
